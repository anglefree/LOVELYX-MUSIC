...
💭 **[{BOT_NAME}](https://t.me/{BOT_USERNAME}) 𝗮𝗹𝗹𝗼𝘄 𝘆𝗼𝘂 𝘁𝗼 𝗽𝗹𝗮𝘆 𝗺𝘂𝘀𝗶𝗰 𝗼𝗻 𝗴𝗿𝗼𝘂𝗽𝘀 𝘁𝗵𝗿𝗼𝘂𝗴𝗵 𝘁𝗵𝗲 𝗻𝗲𝘄 𝗧𝗲𝗹𝗲𝗴𝗿𝗮𝗺'𝘀 𝘃𝗼𝗶𝗰𝗲 𝗰𝗵𝗮𝘁𝘀 𝐩𝐨𝐰𝐞𝐫𝐞𝐝 𝐛𝐲 𝐥𝐨𝐯𝐞𝐥𝐲!**
        ...
        reply_markup=InlineKeyboardMarkup(
            [ 
                [
                    ...
                    InlineKeyboardButton(
                        "💝 ᴅᴇᴠᴇʟᴏᴘᴇʀ", url=f"https://t.me/TUSHAR204")
                ],[
                    InlineKeyboardButton(
                        "👥 ᴏꜰꜰɪᴄɪᴀʟ ꜱᴜᴘᴘᴏʀᴛ", url=f"https://t.me/LOVELYAPPEAL"
                    ),
                    InlineKeyboardButton(
                        "🔥 ᴏꜰꜰɪᴄɪᴀʟ ᴄʜᴀɴɴᴇʟ", url=f"https://t.me/ABOUTVEDMAT")
                ],[
                    InlineKeyboardButton(
                        "😁 ᴏꜰꜰɪᴄɪᴀʟ ᴢᴀɪᴅ ᴄʜᴀᴛ", url="https://t.me/LOVELYAPPEAL")
                ],[
                    InlineKeyboardButton(
    ...
    await message.reply_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                        "✨ ɢʀᴏᴜᴘ", url=f"https://t.me/LOVELYAPPEAL"
                    ),
                    InlineKeyboardButton(
                        "📣 ᴄʜᴀɴɴᴇʟ", url=f"https://t.me/ABOUTVEDMAT"
                    )
                ]
            ]
        )
...
**Please press the button below to read the explanation and see the list of available commands powdered by Lovely!**

⚡ __Powered by {BOT_NAME} Lᴏᴠᴇʟʏ""",
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
...
⚡ __Powered by {BOT_NAME} Lovely__""",
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
